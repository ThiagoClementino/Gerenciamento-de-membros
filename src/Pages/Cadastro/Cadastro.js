    ...
    <div className='layoutform'>   <Header />
     <div className='form'>
        ...
        <div className="abas">
          ...
          <a href="#aba3">Histórico Cristão</a>
          <a href="#aba4">Histórico Congregacional</a>
        ...
        <div className="sectionAbas" id="aba1">
         ...
         <label className="campForm" id='campForm'>
          <p>Nome Completo</p>
          <input type="text" name="name" value={cadMembers.name || ''} onChange={handleSubmitCamps} />
         </label>
         <label className="campForm">
          ...
          <label className="campForm">
                    ...
                    <label className="campForm">
                      <p>Quanto tempo reside no mesmo endereço?</p>
                      <input type="text" 
        ...
        <div className="sectionAbas" id='aba2'>
                    ...
                    <label htmlFor="" className="campForm">
                      <p>Estado Civil</p>
                      <select name="" id="" className="estadocivil" value={cadMembers.maritalstatus || ''} onChange={handleSubmitCamps} >
                    ...
                    <label htmlFor="" className="campForm">
                      ...
                      <h3>Dados do filho</h3>
                        ...
                        <label htmlFor="" className="campForm">
                          ...
                          <select name="optionprimeirocasamento" id="optionprimeirocasamento">
        ...
        <label htmlFor="" className="campForm">
          ...
          <input type="date" name="dataconversao" id="dataconversao" value={cadMembers.dataconversao || ''} onChange={handleSubmitCamps} />
        </label>
        <label htmlFor="" className="campForm">
          <p>Qual foi sua data de batismo nas águas</p>
          <input type="date" name="databatismo" id="databatismo" value={cadMembers.databatismo || ''} onChange={handleSubmitCamps} />
        </label>
        <label htmlFor="" className="campForm">
          <p>Por qual motivo você saiu dela?</p>
          <input type="text" name="motivosaida" id="motivosaida" value={cadMembers.motivosaida || ''} onChange={handleSubmitCamps} />
        </label>
        <label htmlFor="" className="campForm">
          <p>Qual foi a sua última igreja?</p>
          <input type="text" name="lastchurch" id="lastchurch" value={cadMembers.lastchurch || ''} onChange={handleSubmitCamps} />
        </label>
        <label htmlFor="" className="campForm">
        ...
        <label htmlFor="" className="campForm">
          ...
          <select name="dizimista" id="dizimista" value={cadMembers.dizimista || ''} onChange={handleSubmitCamps}>
            <option value="sim">Sim</option>
        ...
        <label htmlFor="" className="campForm">
          ...
          <select name="ofertante" id="ofertante" value={cadMembers.ofertante || ''} onChange={handleSubmitCamps}>
            <option value="sim">Sim</option>
            <option value="não">Não</option>
          </select>
        </label>
        <label htmlFor="" className="campForm">
          ...
          <select name="cargoanterior" id="cargoanterior" value={cadMembers.cargoanterior || ''} onChange={handleSubmitCamps}>
            <option value="sim">Sim</option>
            <option value="não">Não</option>
          </select>
        </label>
        <label htmlFor="" className="campForm">
          ...
          <select name="separadoanterior" id="separadoanterior" value={cadMembers.separadoanterior || ''} onChange={handleSubmitCamps}>
            <option value="sim">Sim</option>
            <option value="não">Não</option>
          </select>
        </label>
        <label htmlFor="" className="campForm">
          ...
          <input type="text" name="posicaoanterior" id="posicaoanterior" value={cadMembers.posicaoanterior || ''} onChange={handleSubmitCamps} />
        </label>
        <label htmlFor="" className="campForm">
          <p>Quais eram as suas atividades?</p>
          <input type="text" name="atividadeanterior" id="atividadeanterior" value={cadMembers.atividadeanterior || ''} onChange={handleSubmitCamps} />
        </label>
        ...
        <div className="sectionAbas" id="aba4">
          <label className="campForm">
            ...
            <select name="problema" id="problema" value={cadMembers.problema || ''} onChange={handleSubmitCamps}>
              <option value="sim">Sim</option>
              <option value="não">Não</option>
            </select>
          </label>
          <label className="campForm">
            ...
            <select name="exortacao" id="exortacao" value={cadMembers.exortacao || ''} onChange={handleSubmitCamps}>
              <option value="sim">Sim</option>
              <option value="não">Não</option>
            </select>
          </label>
          <label className="campForm">
            ...
            <select name="discipulo" id="discipulo" value={cadMembers.discipulo || ''} onChange={handleSubmitCamps}>
              <option value="sim">Sim</option>
              <option value="não">Não</option>
            </select>
          </label>
          <label className="campForm">
            ...
            <select name="participacaocultos" id="participacaocultos" value={cadMembers.participacaocultos || ''} onChange={handleSubmitCamps}>
              <option value="sim">Sim</option>
              <option value="não">Não</option>
            </select>
          </label>
          <label className="campForm">
            <p>Tem o hábito de informar seus pastores sobre ausências na adoração coletiva?</p>
            <textarea name="habito" id="habito" cols="85" rows="3" value={cadMembers.habito || ''} onChange={handleSubmitCamps}></textarea >
          </label>
          <label className="campForm">
            <p>Tem o hábito de participar de cultos de oração?</p>
            <select name="cultosdeoracao" id="cultosdeoracao" value={cadMembers.cultosdeoracao || ''} onChange={handleSubmitCamps}>
              <option value="sim">Sim</option>
              <option value="não">Não</option>
            </select>
          </label>
          <label className="campForm">
            ...
            <select name="aconselhamentopastoral" id="aconselhamentopastoral" value={cadMembers.aconselhamentopastoral || ''} onChange={handleSubmitCamps}>
              <option value="sim">Sim</option>
              <option value="não">Não</option>
            </select>
          </label>
          <label className="campForm">
            ...
            <select name="desenvolvimento" id="desenvolvimento" value={cadMembers.desenvolvimento || ''} onChange={handleSubmitCamps}>
              <option value="sim">Sim</option>
              <option value="não">Não</option>
            </select>
          </label>
        ...
        <div className="sectionAbas" id="aba5">
          <label className="campForm">
            ...
            <textarea name="conviccaodiscipulo" id="conviccaodiscipulo" cols="85" rows="3" value={cadMembers.conviccao} onChange={handleSubmitCamps}></textarea>
          </label>
          <label className="campForm">
            <p>Como você define o evangelho?</p>
            <textarea name="definicaoevangelho" id="definicaoevangelho" cols="85" rows="3" value={cadMembers.definicaoevangelho} onChange={handleSubmitCamps}></textarea>
          </label>
          <label className="campForm">
            <p>Quais são os frutos do Espírito que podem ser claramente percebidos em sua vida?</p>
            <textarea name="frutosespirito" id="frutosespirito" cols="85" rows="3" value={cadMembers.frutosespirito} onChange={handleSubmitCamps}></textarea>
          </label>
          <label className="campForm">
            <p>Como você cuida do desenvolvimento da sua fé e da sua comunhão com Deus?</p>
            <textarea name="desenvolvimentodafe" id="frutosespidesenvolvimentodaferito" cols="85" rows="3" value={cadMembers.desenvolvimentodafe} onChange={handleSubmitCamps}></textarea>
          </label>
          <label className="campForm">
            <p>Existe algum pecado contra qual você tenha lutado nos últimos anos?</p>
            <textarea name="pecado" id="pecado" cols="85" rows="3" value={cadMembers.pecado} onChange={handleSubmitCamps}></textarea>
          </label>
          <label className="campForm">
            <p>Você tem convicções teológicas? Quais seriam?</p>
            <textarea name="conviccaoteologica" id="conviccaoteologica" cols="85" rows="3" value={cadMembers.conviccaoteologica} onChange={handleSubmitCamps}></textarea>
          </label>
          <label className="campForm">
            <p>Você tem o hábito de evangelizar?</p>
            <select name="evangelizar" id="evangelizar" value={cadMembers.evangelizar || ''} onChange={handleSubmitCamps}>
              <option value="sim">Sim</option>
              <option value="não">Não</option>
            </select>
          </label>
          <label className="campForm">
            ...
            <select name="jejuar" id="jejuar" value={cadMembers.jejuar || ''} onChange={handleSubmitCamps}>
              <option value="sim">Sim</option>
              <option value="não">Não</option>
            </select>
          </label>
          <label className="campForm">
            ...
            <select name="leiturabiblica" id="leiturabiblica" value={cadMembers.leiturabiblica || ''} onChange={handleSubmitCamps}>
              <option value="sim">Sim</option>
              <option value="não">Não</option>
            </select>
          </label>
          <label className="campForm">
           ...
           <input type="text" name="livros" id="livros" value={cadMembers.livros} onChange={handleSubmitCamps} />
          </label>
        </div>
        <div className="sectionAbas" id="aba6">
        <label className="campForm">
          <p>Tem alguma coisa a mais que você queria nos contar?</p>
          <textarea name="ultimasconsideracoes" id="ultimasconsideracoes" cols="100" rows="5" value={cadMembers.ultimasconsideracoes} onChange={handleSubmitCamps}></textarea>
        </label>
